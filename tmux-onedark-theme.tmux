...
set "@prefix_highlight_output_prefix" "no"
...
set "status-right" "#[fg=$onedark_green,bg=$onedark_black,nobold,nounderscore,noitalics]#[fg=$onedark_black,bg=$onedark_green,bold] #h "
#set "status-right" ""
